...
To address this issue, our proposed framework automatically generates datasets with **specified item difficulty and discrimination**, allowing more effective evaluation of model performance.
